...
// Fetch booked slots
$result = $conn->query("SELECT slot_no, out_time FROM supermarcheparking");
$bookedSlots = [];
    ...
    <div class="slots">
        <div class="slot-row">
            <?php for ($i = 1; $i <= 3; $i++): ?>
                <button class="slot <?php echo in_array($i, $bookedSlots) ? 'booked' : ''; ?>" 
                        onclick="window.location.href='supermarchebookslot.php?slot_no=<?php echo $i; ?>'" 
        ...
        <div class="center-slot">
            <button class="slot <?php echo in_array(7, $bookedSlots) ? 'booked' : ''; ?>" 
                    onclick="window.location.href='supermarchebookslot.php?slot_no=7'" 
