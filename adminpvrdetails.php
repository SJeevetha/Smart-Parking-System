...
$sql = "SELECT * FROM pvrparking WHERE slot_no LIKE '%$search%' OR vehicle_no LIKE '%$search%' OR name LIKE '%$search%'";
...
<html>
<head>
    <title>PVR Parking Details</title>
    <style>
        body {
            margin: 0;
            padding: 0;
