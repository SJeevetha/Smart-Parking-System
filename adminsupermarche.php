...
$sql = "SELECT * FROM supermarcheparking WHERE slot_no LIKE '%$search%' OR vehicle_no LIKE '%$search%' OR name LIKE '%$search%'";
...
<html>
<head>
    <title>SUPERMARCHE Parking Details</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
<div class="container">
    <h1>SUPERMARCHE Parking Details</h1>
